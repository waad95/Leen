            ...
            <div class="left-section">
                ...
                @foreach ($xmlArray['post'] as $post)
                                    ...
                                    <div class="post">
                                        ...
                                        <div class="date-author">{{ $post['date'] ?? 'No Date' }} | By  {{ $post['author'] ?? 'Anonymous' }} | Likes {{ $post['likes'] ?? '0' }} | Comments {{ $post['comments'] ?? '0' }} </div>
                                        <div class="tag @if(Str::lower($post['category']) =='events') {{Str::lower($post['category'])}}_cat @else {{Str::lower($post['category'])}}@endif">{{ $post['category'] ?? 'No Date' }}</div>
                                    </div>
